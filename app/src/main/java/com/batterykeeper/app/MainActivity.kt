...
import com.batterykeeper.app.ui.screens.SettingsScreen
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 启动监测服务
        if (AppSettings(this).monitorEnabled) {
...
fun MainApp() {
    ...
    val tabs = listOf(
        ...
        TabItem("settings", "设置", Icons.Filled.Tune),
    )

    Scaffold(
        containerColor = ScreenBg,
        bottomBar = {
            NavigationBar(containerColor = Color(0xFF191D21)) {
                ...
                tabs.forEach { tab ->
                    NavigationBarItem(
                        ...
                        colors = NavigationBarItemDefaults.colors(
                            ...
                            unselectedTextColor = TxtTertiary,
